<?php require 'PHP/forgotpass.php'; ?>
<!DOCTYPE html>
<html lang="en">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						<!-- login_wrapper -->
						<h1>CHANGE YOUR <span style="color:#23c0e9;">PASSWORD </span></h1>
                        ...
                        <form action="forgot_pass.php" method="POST">
							<div class="formsix-pos">
								<div class="form-group i-email">
									<input type="email" name="forget_email" class="form-control" required="" id="email2" placeholder="Enter yout email*">
								</div>
							</div>
							<div class="formsix-e">
								<div class="form-group i-password">
									<input type="password" name="forget_pass" class="form-control" required="" id="password2" placeholder="Password *">
								</div>
							</div>
                            <div class="formsix-e">
								<div class="form-group i-password">
									<input type="password" name="forget_pass2" class="form-control" required="" id="password2" placeholder="Confirm Password *">
								</div>
							</div>
							<div class="login_btn_wrapper">
								<button name="save" class="btn btn-primary login_btn"> Change Password </button>
							</div>
                        </form>
