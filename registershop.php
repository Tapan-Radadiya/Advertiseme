            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        <div role="tabpanel">
                            <h1>Register your <span style="color: #23c0e9;">Shop</span></h1></br>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade in active register_left_form" id="contentOne-1">
                                    ...
                                    <div class="row">
                                        <form action="registershop.php" method="post" data-toggle="validator" enctype="multipart/form-data" >  
                                            <!--Form Group-->
                                            <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                                <label for="">Shop Owner Name</label>
                                                <input type="text" name="ShopOwner_Name" value="" placeholder="Shop Owner Name*" required>
                                            </div>
                                             <!--Form Group-->
                                             <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                                <label for="">Shop Name</label>
                                                <input type="text" name="Shop_Name" value="" placeholder="Shop Name*" required>
                                            </div>
                                            
                                            <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                                <label for="">Select Shop-Type</label>
                                            ...
                                            <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <input type="password" name="Password1" value="" placeholder="Shop Password*" required>
                                            </div>
                                            <!--Form Group-->
                                            <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                                <label for="">Re-Type Shop Password</label>
                                                <input id="text" type="password" name="Shop_Pass" placeholder=" Re-Type Shop Password*" required>
                                            </div>
                                            <!--Form Group-->
                                            <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                                <label for="">Enter Your Email-ID</label>
                                                <input type="tel" name="ShopOwner_email" value="" placeholder="Gmail ID" style="text-transform:none;" required>
                                            </div>
                                            <!--Form Group-->
                                            <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                                <label for="">Shop Address</label>
                                                <input type="text" name="Shop_Address" value="" placeholder="Shop Address" style="text-transform:none;height:95px;" required>
                                            </div>
                                            <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                                <label for="">About Your Shop</label>
                                                <input type="text" name="About_Shop" value="" maxlength = "100" placeholder="About your shop" style="text-transform:none;height:95px;" required>
                                            </div>
                                            <!--Form Group-->
                                            <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                                <label for="">Shop Opening Time</label>
                                                <input type="time" name="Shop_OpenTime" value="" placeholder="Shop Opening TIme*" required>
                                            </div>
                                            <!--Form Group-->
                                            <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                                <label for="">Shop Closing Time</label>
                                                <input type="time" name="Shop_CloseTime" value="" placeholder="Shop Closing Time*" required>
                                            </div>
                                            <!--Form Group-->
                                            <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                                <label for="">Phone Number</label>
                                                <input type="number" id="phone" name="Shop_PhoneNo" maxlength="10" placeholder="Phone Number" required>  
                                            </div>
                                            <!--Form Group-->
                                            <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                                <label for="">Shop Location/Google Maps Link</label>
                                                <input type="text" name="Shop_Location" value="" placeholder="Shop location" style="text-transform:none;" required>               
                                            </div>
                                            <!--Form Group-->
                                            <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                           ...
                                           <!--Form Group-->
                                            <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <input type="text" name="Shop_City" value="" placeholder="City" >
                                            </div>
                                            <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                                <label for="">Zip Code</label>
                                                <input type="number" name="Shop_ZipCode" placeholder="Zip Code" required style="maxlength:6;">
                                                   
                                            </div>
                                            <!--Form Group-->
                                            <div class="form-group col-md-6 col-sm-6 col-xs-12 custom_input" >
                                                <label for="cv">Select Shop Logo Or Card Image</label>
                                                <input id="fileupload" type="file" name="shopimg1" required/>
                                                <!--<div id="dvPreview"></div>-->
                                                <label for="cv">Select Shop Menu Card or Price Details</label>
                                                <input id="fileupload" type="file" name="shopimg2" required/>
                                                <!--<div id="dvPreview"></div>-->
                                                <label for="cv">Select Shop Image</label>
                                                <input id="fileupload" type="file" name="shopimg3" required/>
                                                <!--<div id="dvPreview"></div>-->
                                                <label for="cv">Select Shop Image</label>
                                                <input id="fileupload" type="file" name="shopimg4" required/>
                                                <!--<div id="dvPreview"></div>-->
                                                <label for="cv">Select Shop Image</label>
                                                <input id="fileupload" type="file" name="shopimg5" required/>
                                                <!--<div id="dvPreview"></div>-->
                                            </div>
                                            ...
                                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="check-box text-center">
                                                    ...
                                                    &ensp;
                                                    <label for="account-option_1">I agreed to the <a href="terms.php"class="check_box_anchr">Terms and Conditions</a> governing
                                                        the use of jobportal</label>
                                                </div>
                                            </div>
                                            <div class="login_btn_wrapper register_btn_wrapper login_wrapper ">
                                                 <button type="submit" name="submit" class="btn btn-primary login_btn">Submit Your Details</button>
                                            </div>
                                        </form>
                                    </div>
                            ...
                            <div class="jp_footer_candidate_wrapper jp_footer_candidate_wrapper4">
                                <div class="jp_footer_candidate">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="contacctus.php"><i class="fa fa-caret-right" aria-hidden="true"></i> Contact Us</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
