...
<body>
    ...
    <div class="register_section">
        ...
        <h1 style="text-align:center;letter-spacing:2px;font-family:Helvetica ;"> <u><b>TERMS & CONDITION</b></u></h1>
</br>
        <p class="about" style="font-family:Montserrat;padding-left:2%;padding-right:2%;letter-spacing:2px;">This document is an electronic 
        record in terms of the amended Information Technology Act, 2000 and rules and regulation made thereunder. This electronic record is 
        generated by a computer system and does not require any physical or digital signatures. This document is published in accordance with 
        the provisions of Rule 3 (1) of the Information Technology (Intermediaries Guidelines) Rules, 2011 that require publishing the Terms 
        for access or usage of <b><b>AdvertiseMe</b>’s</b> service via <b>AdvertiseMe</b> Portal. This document meets the stipulations and conditions mentioned in 
        Section 65B (2) of the Indian Evidence Act, 1872.This is an agreement between <b>AdvertiseMe</b> Ltd., a company incorporated under the 
        Companies Act 1956 with its registered office at Building M, 501-B, Palm Court Complex, Besides Goregaon Sports Club, New Link Road,
         Malad (W), Mumbai 400 064, the owner and operator of www.<b>AdvertiseMe</b>.com (the "<b>AdvertiseMe</b> Site"), the <b>AdvertiseMe</b> Application Software 
         "<b>AdvertiseMe</b> Mobile App", including collectively, including all content provided by <b>AdvertiseMe</b> through <b>AdvertiseMe</b> Application and the 
         <b>AdvertiseMe</b> Site, the "<b>AdvertiseMe</b> Service", or the "Service", and you ("you" or "You"), a user of the Service. BY USING THE SERVICE,
          YOU ACKNOWLEDGE AND AGREE TO THESE TERMS OF SERVICE, TERMS OF USE FOR SEARCH PLUS SERVICES, INFRINGEMENT POLICY, Contest and 
          Refer & Earn program terms, SOFTWARE LICENSE AGREEMENT, HOSTING SERVICES AGREEMENT, SOFTWARE LICENSE AND HOSTING AGREEMENT, 
          UPI TERMS , JD PAY (Receiver), JD PAY (Sender), Service For Listing, <b>AdvertiseMe</b> Messenger, Terms for Digital Catalogue-B2B, 
          Reseller Terms, Terms of use for Real Estate, Terms Of Use For Information Dissemination, TERMS & CONDITIONS (JD OMNI), Terms 
          and conditions for JDRR CERTIFICATE AND <b>AdvertiseMe</b>'S PRIVACY POLICY, WHICH CAN BE FOUND AT PRIVACY P
        OLICY AND WHICH ARE INCORPORATED HEREIN BY REFERENCE. If you choose to not agree with any of these terms, you may not use the Service.</p>
    </div>
    <!-- Footer Start-->
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="jp_bottom_footer_left_cont">
                                        <p>© 2022-23 <b>AdvertiseMe</b>. All Rights Reserved.</p>
                                    </div>
