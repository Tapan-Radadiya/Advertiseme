                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 hidden-sm hidden-xs">
                        <div class="jp_navi_right_btn_wrapper">
                            <ul>
                                <li><a href="Customer_login.php"><i class="fa fa-plus-circle"></i>&nbsp;Login</a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        <div role="tabpanel">
                            <h1>REGISTER TO YOUR <span style="color:#23c0e9;">CUSTOMER</span> ACCOUNT</h1></br>
                            <div class="tab-content">
                                <div class="tab-pane fade in active register_left_form" id="contentOne-1">
                                    ...
                                    <div class="row">
                                        <form action="Customer_register.php" data-toggle="validator" method="POST">
                                                <?php
                                                if(count($errors) == 1){
                                                ?>
                                                ...
                                                <?php
                                                    foreach($errors as $showerror){
                                                ?>
                                                <div class="alert alert-danger" role="alert"><?php echo $showerror; ?></div>
                                                <?php
                                                    }
                                                ?>
                                            ...
                                            <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <input type="text" name="Cust_name" value="" placeholder="Customer Name*" style="text-transform: none;" required>
                                            </div>
                                             
                                            <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                                <label for="">Enter Your Email-ID</label>
                                                <input type="email" name="Cust_email" value="" placeholder="Enter your email-ID*" style="text-transform: none;" required >
                                            </div>
                                            <!--Form Group-->
                                            <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                                <label for="">Enter Your Mobile No</label>
                                                <input type="number" name="Cust_mob" value="" placeholder="Enter Your Mobile No" style="text-transform: none;" required>
                                            </div>
                                            <!--Form Group-->
                                            <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                                <label for="">Enter Your Password</label>
                                                <input type="password" name="Cust_pass" value="" placeholder="Enter Password*" style="text-transform: none;" required >
                                            </div>
                                            ...
                                            <div class="login_btn_wrapper register_btn_wrapper login_wrapper ">
                                                <button type="submit" class="btn btn-primary login_btn" name="submit">Submit Your Details</button>
                                                <!-- <a type="submit" href="javascript:;" class="btn btn-primary login_btn"> register </a> -->
                                            </div>
                                        </form>
                                    </div>
                                    <div class="login_message">
                                        <p>Already Registered As a Customer? <a href="Customer_login.php"> Login Here </a> </p>
                                    </div>
                                </div>
                                <div class="tab-pane fade register_left_form" id="contentOne-2">
                                    ...
                                    <div class="login_message">
                                        <p>Already a member? <a href="Customer_login.html"> Login Here </a> </p>
                                    </div>
                                </div>
                            </div>
...
<!--<script>
    window.onload = function preview(){
        confirm("You Need To Register As a  Customer To See All Details Of This Shop");
    }     
</script>-->
