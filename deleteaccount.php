<?php require 'PHP/deleteaccount.php'; ?>
<!DOCTYPE html>
<html lang="en">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						<!-- login_wrapper -->
						<h1>Delete Your <span style="color:#23c0e9;">Account </span></h1>
                        ...
                        <form action="deleteaccount.php" method="POST">
							<div class="formsix-pos">
								<div class="form-group i-email">
									<input type="email" name="delete_email" class="form-control" required="" id="email2" placeholder="Enter your email*">
								</div>
							</div>
							<div class="formsix-e">
								<div class="form-group i-password">
									<input type="password" name="delete_pass" class="form-control" required="" id="password2" placeholder="Password *">
								</div>
							</div>
                            <div class="formsix-pos">
								<div class="form-group i-email">
									<input type="text" name="reason" class="form-control" required="" id="reason" placeholder="Enter a reason For Deleting The Account*">
								</div>
							</div>
							<div class="login_btn_wrapper">
								<button name="save" class="btn btn-primary login_btn"> Delete Acccount </button>
							</div>
                        </form>
