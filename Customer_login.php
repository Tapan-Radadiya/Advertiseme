<?php require 'PHP/cust_login.php'; ?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 hidden-sm hidden-xs">
                        <div class="jp_navi_right_btn_wrapper">
                            <ul>
                                <li><a href="Customer_register.php"><i class="fa fa-plus-circle"></i>&nbsp;Customer</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						<!-- login_wrapper -->
						<h1>LOGIN TO YOUR <span style="color:#23c0e9;">CUSTOMER</span> ACCOUNT</h1>
                        ...
                        <form action="Customer_login.php" method="POST">
							<div class="formsix-pos">
								<div class="form-group i-email">
									<input type="email" name="cust_email" class="form-control" required="" id="email2" placeholder="Customer email*">
								</div>
							</div>
							<div class="formsix-e">
								<div class="form-group i-password">
									<input type="password" name="cust_pass" class="form-control" required="" id="password2" placeholder="Password *">
								</div>
							</div>
							...
							<div class="login_btn_wrapper">
								<button name="login" class="btn btn-primary login_btn"> Login </button>
							</div>
                        </form>
